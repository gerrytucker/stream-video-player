...
<script type="text/javascript" charset="utf-8" src="<?php echo get_bloginfo('url'); ?>/wp-includes/js/jquery/jquery.js"></script><script type="text/javascript" src="<?php echo plugins_url('/stream-video-player/button/jquery.treeview.js'); ?>"></script>
